...
namespace Engine
{
	namespace Math
	{
		...
		public:
			...
			static void xmStore(Vector4& vector, const XMFLOAT4& other);
			static void xmStore(Vector4& vector, const XMFLOAT4* other);
			static void xmStore(Vector4& vector, const XMVECTOR& other);
			static void xmStore(Vector4& vector, const Vector4& other);
			...
			static void xmStore(XMFLOAT4& vector, const XMFLOAT4& other);
			static void xmStore(XMFLOAT4& vector, const XMFLOAT4* other);
			static void xmStore(XMFLOAT4& vector, const XMVECTOR& other);
			static void xmStore(XMFLOAT4& vector, const Vector4& other);
