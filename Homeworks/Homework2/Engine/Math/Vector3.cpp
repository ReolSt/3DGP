...
// ----------------------------------------------------------------------
		...
		void Vector3::xmStore(Vector3& vector, const XMFLOAT3& other)
		{
		...
		void Vector3::xmStore(Vector3& vector, const XMVECTOR& other)
		{
			vector.xmStore(other);
		}

		void Vector3::xmStore(Vector3& vector, const Vector3& other)
		{
			vector.xmStore(other);
		}

		XMVECTOR Vector3::xmLoad(const Vector3& vector)
		{
		...
		void Vector3::xmStore(XMFLOAT3& vector, const XMFLOAT3& other)
		{
			vector = other;
		}
		...
		void Vector3::xmStore(XMFLOAT3& vector, const XMVECTOR& other)
		{
			XMStoreFloat3(&vector, other);
		}

		void Vector3::xmStore(XMFLOAT3& vector, const Vector3& other)
		{
			XMStoreFloat3(&vector, other.xmLoad());
		}

		XMVECTOR Vector3::xmLoad(const XMFLOAT3& vector)
		{
		...
		void Vector3::xmStore(XMFLOAT3* vector, const XMFLOAT3& other)
		{
			XMStoreFloat3(vector, XMLoadFloat3(&other));
		}
