...
namespace Engine
{
	namespace Math
	{
		...
		public:
			...
			static void xmStore(Vector3& vector, const XMFLOAT3& other);
			static void xmStore(Vector3& vector, const XMFLOAT3* other);
			static void xmStore(Vector3& vector, const XMVECTOR& other);
			static void xmStore(Vector3& vector, const Vector3& other);
			...
			static void xmStore(XMFLOAT3& vector, const XMFLOAT3& other);
			static void xmStore(XMFLOAT3& vector, const XMFLOAT3* other);
			static void xmStore(XMFLOAT3& vector, const XMVECTOR& other);
			static void xmStore(XMFLOAT3& vector, const Vector3& other);
