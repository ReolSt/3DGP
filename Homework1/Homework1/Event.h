...
namespace Engine
{
	...
	public:
		...
		Event(EventType type) { setType(type); }
	...
	public:
		...
		WindowEvent(EventType type, int x, int y, int width, int height);
	...
	public:
		...
		MouseEvent(EventType type, const std::vector<KeyCode>& buttons, int x, int y, int wheelDelta);

		// ----------------------------------------------------------------------
		// Getter Setter
		// ----------------------------------------------------------------------

		std::vector<KeyCode> getButtons() const { return m_buttons; }
		int getX() const { return m_x; }
		int getY() const { return m_y; }
		int getWheelDelta()  const { return m_wheelDelta; }

		void setButtons(const std::vector<KeyCode>& buttons)
		{
